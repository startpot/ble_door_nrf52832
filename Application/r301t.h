...
//状态寄存器
#define     SYS_PARAM_BUSY_BIT              0   //1表示系统正在执行命令，0表示空闲
#define     SYS_PARAM_PASS_BIT              1   //1表示指纹验证通过
#define     SYS_PARAM_PWD_BIT               2   //1表示设备握手口令通过验证。
#define     SYS_PARAM_IBS_BIT                   3   //IBS ImgBufStat    1表示指纹图像缓冲区存在有效指纹图像
